...
%% ヘッダ右の設定
%% 変更しないでください．
\markright{Open CAE Symposium 2018, Dec. 8-9, 2018, Kawasaki} % Do not edit this line
%%
%% 本文
\begin{document}
%%
...
%
\lstinputlisting[caption={Header of template\_OpenCAE\_symposium.tex.},language={tex},linerange={1-10},label={code:template_OpenCAE_symposium.tex}]
{./template_OpenCAE_symposium.tex}
%
\end{document}
