...
\title{オープンCAE学会論文集印刷用原稿の書き方（和文表題）}
% 副題が無い場合にはコメントアウトします．
...
%% 本文が英語の場合には表示されません．
\etitle{Manuscripts preparation guide for the journal of the Open CAE Society of Japan (English Title)}
% 副題が無い場合にはコメントアウトします．
...
%% ヘッダ右の設定
%% 変更しないでください．
\markright{Journal of the Open CAE Society of Japan, OpenCAE0000-000} % Do not edit this line
%%
%% 本文
\begin{document}
%%
...
\item 段組 : 1段組です．
\item 頁数 : \href
{http://www.opencae.or.jp/journal/submission/}
{論文の投稿について}%
における投稿規程をご参照ください．
\end{itemize}
%%
...
\item 文字の大きさ
  ...
  \item 題目 : 14ポイント
  \item 副題・大見出し : 12ポイント
  \item ヘッダ・フッタ・Appendixにおけるコード引用 : 8ポイント
...
\item URL : リンクを付加してください．
  ...
  リンクされた文字は青色としてください．
\item 提出方法 : オープンCAE学会論文集のWEBページ
  \href
  {http://www.opencae.or.jp/journal/}
  {http://www.opencae.or.jp/journal/}
  をご参照の上，提出してください．
\end{itemize}
%%%
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l|l}
    ...
    \hline
    \end{tabular}
  \caption{Secretariat of the OpenCAE Society Japan}
  \label{tab:Secretariat}
\end{table}
%%
%% 参考文献
%% thebibliography環境を用いる場合
%% template_OpenCAE_journal.bblに直接参考文献を記述し，
%% 以下の行を有効にしてください．
\input{template_OpenCAE_journal.bbl}
%% BiBTeXを用いる場合
%% template_OpenCAE_journal.bibに参考文献データベースを記述し，
%% 以下の2行を有効にし，MakefileでBiBTeXを使うように設定してください．
%\bibliography{template_OpenCAE_journal}
...
%
\lstinputlisting[
caption={template\_OpenCAE\_journal.texの冒頭}
,language={tex}
,linerange={1-8}
,label={code:template_OpenCAE_journal.tex}]
{{./template_OpenCAE_journal.tex}}
%
\end{document}
